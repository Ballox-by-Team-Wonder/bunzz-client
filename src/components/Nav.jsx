...
import identifyLogo from "../assets/identify-logo.png"

const routes = {
  dashboard: ['/', '/home', '/airdrops', '/chat', '/activities'],
  wallet: '/wallet',
  identifyNfts: '/identify-nfts',
...
function Nav() {
  ...
  return (
    <nav
      id="mainNavbar"
      className="navbar navbar-vertical navbar-expand-lg scrollbar"
    >
          ...
          <ul className="navbar-nav mb-lg-7">
            ...
            <li className="nav-item">
              <Link className={`nav-link ${isActiveLink(routes.wallet)}`} to="/wallet">
                ...
                <span>Wallet $Unify</span>
              </Link>
            </li>
            <li className="nav-item">
              <Link className={`nav-link ${isActiveLink(routes.identifyNfts)}`} to="/identify-nfts">
                <svg
                  viewBox="0 0 24 24"
                  className="nav-link-icon"
                  height={18}
