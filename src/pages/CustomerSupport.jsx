                  ...
                  <div className="row mb-6">
                    <div className="col-xl-6">
                      ...
                      <div className="d-flex mb-6">
                        ...
                        <div>
                          ...
                          <p className="mb-0">
                            Donec non diam nec leo efficitur congue ut ac nisi.
                            Integer ut tincidunt ligula, nec cursus augue. Proin
                            sed augue magna. Sed viverra vehicula faucibus.
                          </p>
                        </div>
                      </div>
                      <div className="d-flex mb-6">
                        ...
                        <div>
                          ...
                          <p className="mb-0">
                            Phasellus efficitur nunc et tortor aliquam rhoncus.
                            Ut facilisis malesuada tincidunt. Aliquam mollis
                            lectus et.
                          </p>
                        </div>
                      </div>
                      <div className="d-flex mb-6">
                        ...
                        <div>
                          ...
                          <p className="mb-0">
                            Aliquam ornare malesuada enim eget congue. Nam massa
                            purus, consequat a libero eu, molestie sollicitudin
                            neque?Quisque varius vulputate leo non blandit. Sed
                            iaculis justo.
                          </p>
                        </div>
                      </div>
                      <div className="d-flex mb-6">
                        ...
                        <div>
                          ...
                          <p className="mb-0">
                            ...
                            efficitur. Fusce dictum lobortis nunc vitae mattis.
                            Vivamus ac tellus iaculis, aliquam augue ut libero.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-xl-6">
                      ...
                      <div className="d-flex mb-6">
                        ...
                        <div>
                          <h3 className="h4 mb-0">
                            Ut ut urna ut felis vulputate bibendum eu quis leo?
                          </h3>
                          <p className="mb-0">
                            Nunc fermentum gravida nisi, vehicula consectetur
                            libero mattis eu. Vestibulum pharetra massa in purus
                            ullamcorper, in malesuada enim congue. Pellentesque
                            efficitur nec erat.
                          </p>
                        </div>
                      </div>
                      <div className="d-flex mb-6">
                        ...
                        <div>
                          ...
                          <p className="mb-0">
                            ...
                            consequat nisi. Curabitur viverra vitae purus vitae
                      ...
                      <div className="d-flex mb-6">
                        ...
                        <div>
                          ...
                          <p className="mb-0">
                            Curabitur dictum turpis vitae commodo tincidunt. Nam
                            id faucibus tortor. Donec elementum nunc diam, nec
                            imperdiet libero auctor et. Cras maximus justo in
                            commodo auctor.
                          </p>
                        </div>
                      </div>
