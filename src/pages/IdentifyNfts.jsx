                ...
                >
                  <div className="modal-content">
                    ...
                    {/* <div class="modal-body">
                      <img src="assets/images/identify/bunzzLogo.jpg" alt="" srcset="" class="rounded mx-auto d-block" style="width:50%;">
                ...
                <div className="col-6">
                  <div className="card h-100">
                    ...
                    <div className="card-footer">
                      <small className="text-muted">Nfts Status: Minted</small>
                    </div>
                  </div>
                </div>
                <div className="col-6">
                  <div className="card h-100">
                    ...
                    <div className="card-footer">
                      <small className="text-muted">Nfts Status: Listed</small>
                    </div>
                  </div>
                </div>
                <div className="col-6">
